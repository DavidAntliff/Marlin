...
#define STRING_CONFIG_H_AUTHOR "David Antliff, TEVO Tarantula Custom Config" // Original author or contributor.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)

// @section machine

// Original controller board with built in stepper drivers. Works with MKS BASE 1.3, 1.4
