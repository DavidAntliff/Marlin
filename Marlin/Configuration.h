...
#define STRING_CONFIG_H_AUTHOR "(David Antliff, TEVO Tarantula Custom Config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 58.75
  #define DEFAULT_bedKi 4.24
  #define DEFAULT_bedKd 542.28
